package com.blackgear.cavebiomeapi.core.platform.common.fabric;

import com.blackgear.cavebiomeapi.core.CaveBiomeAPI;
import com.blackgear.cavebiomeapi.core.platform.common.BiomeContext;
import com.blackgear.cavebiomeapi.core.platform.common.BiomeManager;
import com.blackgear.cavebiomeapi.core.platform.common.BiomeWriter;
...
public class BiomeManagerImpl {
    public static void bootstrap() {
        BiomeModifications.create(new ResourceLocation(CaveBiomeAPI.MOD_ID, "biome_modifier")).add(ModificationPhase.ADDITIONS, context -> true, (selector, modifier) -> BiomeManager.INSTANCE.register(new FabricBiomeWriter(selector, modifier)));
    }
