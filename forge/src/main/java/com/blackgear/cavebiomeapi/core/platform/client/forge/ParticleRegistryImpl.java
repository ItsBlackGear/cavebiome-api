package com.blackgear.cavebiomeapi.core.platform.client.forge;

import com.blackgear.cavebiomeapi.core.CaveBiomeAPI;
import com.blackgear.cavebiomeapi.core.platform.client.ParticleRegistry;
...
@Mod.EventBusSubscriber(modid = CaveBiomeAPI.MOD_ID, value = Dist.CLIENT, bus = Mod.EventBusSubscriber.Bus.MOD)
